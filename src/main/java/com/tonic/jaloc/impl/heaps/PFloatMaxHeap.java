...
/**
 * A growable native float max-heap.
 */
public final class PFloatMaxHeap extends AbstractPrimitiveHeap<PFloatArray, PFloatWriter> {
    /**
     * Creates an empty heap with zero capacity on the system allocator.
     */
    public PFloatMaxHeap() {
        this(0);
    }
     ...
     */
    public PFloatMaxHeap(long initialCapacity) {
     ...
     * @throws IllegalArgumentException if initialCapacity is negative
     */
    public PFloatMaxHeap(NativeAllocator allocator, long initialCapacity) {
     ...
     */
    public PFloatMaxHeap(float... values) {
     ...
     * @throws NullPointerException if values is null
     */
    public PFloatMaxHeap(NativeAllocator allocator, float... values) {
        super(allocator, new PFloatArray(allocator, Objects.requireNonNull(values, "values").length));
