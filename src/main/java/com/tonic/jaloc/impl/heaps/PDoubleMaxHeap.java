...
/**
 * A growable native double max-heap.
 */
public final class PDoubleMaxHeap extends AbstractPrimitiveHeap<PDoubleArray, PDoubleWriter> {
    /**
     * Creates an empty heap with zero capacity on the system allocator.
     */
    public PDoubleMaxHeap() {
        this(0);
    }
     ...
     */
    public PDoubleMaxHeap(long initialCapacity) {
     ...
     * @throws IllegalArgumentException if initialCapacity is negative
     */
    public PDoubleMaxHeap(NativeAllocator allocator, long initialCapacity) {
     ...
     */
    public PDoubleMaxHeap(double... values) {
     ...
     * @throws NullPointerException if values is null
     */
    public PDoubleMaxHeap(NativeAllocator allocator, double... values) {
