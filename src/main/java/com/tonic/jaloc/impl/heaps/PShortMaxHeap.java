...
/**
 * A growable native short max-heap.
 */
public final class PShortMaxHeap extends AbstractPrimitiveHeap<PShortArray, PShortWriter> {
    /**
     * Creates an empty heap with zero capacity on the system allocator.
     */
    public PShortMaxHeap() {
        this(0);
    }
     ...
     */
    public PShortMaxHeap(long initialCapacity) {
     ...
     * @throws IllegalArgumentException if initialCapacity is negative
     */
    public PShortMaxHeap(NativeAllocator allocator, long initialCapacity) {
     ...
     */
    public PShortMaxHeap(short... values) {
     ...
     * @throws NullPointerException if values is null
     */
    public PShortMaxHeap(NativeAllocator allocator, short... values) {
        super(allocator, new PShortArray(allocator, Objects.requireNonNull(values, "values").length));
