...
/**
 * The contiguous-storage base for struct collections: layout, view factory, and array creation.
 */
public abstract class AbstractStructList<T extends PStruct> extends AbstractNativeList<PStructArray<T>, PStructWriter<T>>
{
    private final StructLayout layout;
    private final StructViewFactory<T> viewFactory;

    protected AbstractStructList(NativeAllocator allocator, StructLayout layout, StructViewFactory<T> viewFactory, long capacity)
    {
